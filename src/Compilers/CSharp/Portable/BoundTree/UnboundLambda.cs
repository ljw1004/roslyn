...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal sealed partial class BoundLambda : IBoundLambdaOrFunction
    {
            ...
            : this(syntax, (LambdaSymbol)binder.ContainingMemberOrLambda, body, diagnostics, binder, type)
        {
            if (inferReturnType)
            {
                this._inferredReturnType = InferReturnType(this.Body, this.Binder, this.Symbol.IsAsync, this.Type, ref this._inferredReturnTypeUseSiteDiagnostics, out this._refKind, out this._inferredFromSingleType);
        ...
        private static TypeSymbol InferReturnType(BoundBlock block, Binder binder, bool isAsync, TypeSymbol delegateTargetType, ref HashSet<DiagnosticInfo> useSiteDiagnostics, out RefKind refKind, out bool inferredFromSingleType)
        {
